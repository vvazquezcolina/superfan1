...
export default async function Image({
  ...
  const title = isEs ? 'PLANIFICADOR DE\nPRESUPUESTO' : 'BUDGET\nPLANNER'
  const subtitle = isEs ? 'Calcula cuánto cuesta tu aventura mundialista' : 'Calculate your World Cup adventure cost'
