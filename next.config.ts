...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://tp.media https://www.travelpayouts.com https://emrldtp.com https://va.vercel-scripts.com",
      "style-src 'self' 'unsafe-inline' https://tp.media https://www.travelpayouts.com",
      "img-src 'self' data: blob: https://images.pexels.com https://www.google-analytics.com https://tp.media https://www.travelpayouts.com https://pics.avs.io",
      "font-src 'self' https://tp.media https://www.travelpayouts.com data:",
      "connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://www.googletagmanager.com https://tp.media https://www.travelpayouts.com https://emrldtp.com https://vitals.vercel-insights.com",
      "frame-src 'self' https://tp.media https://www.travelpayouts.com https://www.booking.com",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
